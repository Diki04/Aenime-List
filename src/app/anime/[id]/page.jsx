...
const Page = async({ params : {id}}) => {
  ...
  return (
    ...
    <div className='pt-4 px-4 sm:flex-nowrap flex-wrap gap-2 text-color-primary grid place-items-center h-screen '>
      <Image
      src={anime.data.images.webp.image_url}
      alt={anime.data.images.jpg.image_url}
      width={250}
      height={250}
      className="w-80 rounded object-cover"/>
      <p className='text-justify text-xl'>{anime.data.synopsis}</p>
    </div>
    <div className=' p-4'>
      <h3 className='text-color-primary text-2xl mb-2'>Views Comment</h3>
